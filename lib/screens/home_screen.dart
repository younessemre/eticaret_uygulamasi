  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const AppNameTextWidget(label: "Ana Sayfa",fontSize: 20),
      ),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const TitleTextWidget(label: "En çok görüntülenenler"),
            ...
            GridView.count(
              shrinkWrap: true,
                ...
                crossAxisCount: 4,
              children: List.generate(AppConstans.categoriesList.length, (index) {
